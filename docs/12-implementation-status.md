...
- **เฟส B ที่เหลือ (ยังไม่ทำ — ข้อมูลต้นทางไม่มี granularity):** หน้า 4-6 (รายการ 5-11: ต้นทุนผลิตแยกวัตถุดิบ/ค่าแรง/โสหุ้ย, รายจ่ายขายบริหาร itemized, รายจ่ายต้องห้ามแยกประเภท, รายได้ยกเว้น, ขาดทุน 5 ปีรายปี) — ผังงบ FS หยาบกว่า sub-line CIT50 (เช่น "C" = ต้นทุนรวม ไม่แยก; add-back เก็บยอดรวมไม่แยกประเภท) → **ไม่ใช่ปัญหา mapping แต่ข้อมูลต้นทางไม่ถูกเก็บระดับนั้น** → กรอกมือ; หน้า 8 = คำรับรอง/ความเห็นผู้สอบ+ลายเซ็น (มือ); checkbox BOI หน้า 2 Group3 (ต้องรู้สิทธิ BOI). cleanup: ลบ free-text legacy บน CompanyAuditor หลัง backfill ทุก env
