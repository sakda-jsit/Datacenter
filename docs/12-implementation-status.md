...
- **เฟส B (ยังไม่ทำ):** หน้า 3-7 รายละเอียดงบกำไรขาดทุน/งบดุล/ปรับปรุงกำไร (map ทีละช่อง — ใหญ่, ซ้ำงบการเงิน); checkbox BOI หน้า 2 (Group3 ลดหย่อน/ยกเว้น — ต้องรู้สิทธิ BOI); ลายเซ็น/วันที่ยื่น (เซ็นมือ). cleanup: ลบ free-text legacy บน CompanyAuditor หลัง backfill ทุก env
