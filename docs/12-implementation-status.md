...
- **เฟส B (ยังไม่ทำ):** หน้า 3-7 รายละเอียดงบกำไรขาดทุน/งบดุล/ปรับปรุงกำไร (map ทีละช่อง — ใหญ่, ซ้ำงบการเงิน); เลขผู้เสียภาษีสำนักงานสอบ/ทำบัญชี (field 49/52) + ลายเซ็น/วันที่ยื่น (เซ็นมือ)
