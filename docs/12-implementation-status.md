...
- **เฟส B ที่เหลือ (ยังไม่ทำ — ติดข้อมูล granular):** หน้า 4-6 (รายการ 5-11: ต้นทุนผลิต/รายได้อื่น/รายจ่ายอื่น/รายจ่ายขายบริหาร/รายจ่ายต้องห้าม itemized/รายได้ยกเว้น/ขาดทุน 5 ปี) + หน้า 7 รายการ 12 บรรทัด BS 140-159 — **ต้องการ mapping บัญชี→บรรทัด schedule CIT50** (ระบบ map บัญชี→ผังงบ DBD/NPAE ไม่ใช่ taxonomy CIT50) หรือกรอกมือ; หน้า 7 เติมได้เฉพาะ 4 ยอดรวม (รวมสินทรัพย์/หนี้สิน/ทุน/รวม) จาก BalanceSheet; หน้า 8 = คำรับรอง/ความเห็นผู้สอบ+ลายเซ็น (มือ); checkbox BOI หน้า 2 Group3 (ต้องรู้สิทธิ BOI). cleanup: ลบ free-text legacy บน CompanyAuditor หลัง backfill ทุก env
