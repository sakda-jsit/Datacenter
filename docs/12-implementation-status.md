...
- **เฟส B (ยังไม่ทำ):** หน้า 3-7 รายละเอียดงบกำไรขาดทุน/งบดุล/ปรับปรุงกำไร (map ทีละช่อง — ใหญ่, ซ้ำงบการเงิน); ลายเซ็น/วันที่ยื่น (เซ็นมือ). อนาคต: ทะเบียนผู้สอบ/ผู้ทำบัญชีเป็น master ใช้ซ้ำหลายลูกค้า (ตอนนี้กรอกชื่อต่อปี)
